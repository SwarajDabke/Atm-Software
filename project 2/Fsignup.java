...
class Fsignup extends JFrame implements ActionListener
		{
			...
			if (ae.getSource() == b)
			{
				...
				try{
					...
					}else
					{
						...
						//JOptionPane.showMessageDialog(null,""+t6.getText());			
						String formno = first;
						...
						//Connection c =DriverManager.getConnection("jdbc:mysql://localhost:3306/swaraj1?autoReconnect=true&useSSL=false","root","143198");
						...
						{
							setVisible(false);
							new Fsignup2(first).setVisible(true);
						} else
						{
